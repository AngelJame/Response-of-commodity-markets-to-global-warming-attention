...
steps = 1;
vardec_opt = 1;  
result=gdfm_onesided1(panel, q, r, m, h, steps, vardec_opt);
%function [chi, xi, X, factors, loadings, forecast_chi, vardec] = gdfm_onesided1(panel, q, r, m, h, steps, vardec_opt)
function  xi = gdfm_onesided1(panel, q, r, m, h, steps, vardec_opt)
...
if vardec_opt == 1
    [P_X, D_X, Sigma_X] = spectral(X, 12, h, m);                             % compute all dynamic eigenvalues
